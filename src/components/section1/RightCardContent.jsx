...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 p-8 h-full w-full  flex flex-col justify-between'>
        ...
        <div>
            <p className='text-shadow-2xs text-xl leading-relaxed text-white mb-14'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sunt natus quia magnam officiis fugiat libero!
            </p>
